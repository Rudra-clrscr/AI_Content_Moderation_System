-- Safe to re-run: creates the table only if it doesn't exist.
IF OBJECT_ID(N'dbo.moderation_events', N'U') IS NULL
BEGIN
    CREATE TABLE dbo.moderation_events (
        ...
        gate_version VARCHAR(50) NULL,   -- gate_patterns.yaml "version" can be a string
